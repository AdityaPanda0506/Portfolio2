...
const FinSentinelImages = ({ scrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={adjustedScrollPercent}>
        ...
        <h4>FinBERT</h4>
        <span>NLP Sentiment Scoring</span>
      </Layer4>
      <Layer3 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>XGBoost</h4>
        <span>Ensemble Trading Signal</span>
      </Layer3>
      ...
      <Layer1 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>Streamlit</h4>
        <span>Interactive Backtesting</span>
      </Layer1>
    </>
  );
};
