...
const CloudGuardImages = ({ scrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      ...
      <Layer3 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>Amazon S3</h4>
        <span>Dataset upload triggers</span>
      </Layer3>
      <Layer2 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>AWS Lambda</h4>
        <span>Serverless real-time scoring</span>
      </Layer2>
      <Layer1 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>CloudGuard</h4>
        <span>40% review boost</span>
      </Layer1>
    </>
  );
};
