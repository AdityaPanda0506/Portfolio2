...
const ChemicalSDSImages = ({ scrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={adjustedScrollPercent}>
        ...
        <span>Safety report builder</span>
      </Layer4>
      <Layer3 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>ChemSpider</h4>
        <span>Structure validations</span>
      </Layer3>
      <Layer2 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>PubChem API</h4>
        <span>Live hazard reports</span>
      </Layer2>
      <Layer1 $scroll={adjustedScrollPercent}>
        <div className="star">*</div>
        <h4>SDS Generator</h4>
        <span>React & Node app</span>
      </Layer1>
    </>
  );
};
