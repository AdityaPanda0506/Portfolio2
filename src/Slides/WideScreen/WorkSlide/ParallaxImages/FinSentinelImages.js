...
const FinSentinelImages = ({ scrollPercent: initialScrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={scrollPercent}>
        ...
        <h4>FinBERT Sentiment</h4>
        <span>3M+ Articles Sentiment Scored</span>
      </Layer4>
      <Layer3 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>XGBoost & LightGBM</h4>
        <span>Ensemble Model Predictor</span>
      </Layer3>
      ...
      <Layer1 $scroll={scrollPercent}>
        ...
        <span>Interactive Backtesting App</span>
      </Layer1>
    </>
  );
}

FinSentinelImages.propTypes = {
...
export default FinSentinelImages;
