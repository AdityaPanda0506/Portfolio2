...
const ChemicalSDSImages = ({ scrollPercent: initialScrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={scrollPercent}>
        ...
        <h4>SDS PDF Engine</h4>
        <span>Structured safety reports compiled in real time</span>
      </Layer4>
      <Layer3 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>ChemSpider API</h4>
        <span>Integration for chemical structure validation</span>
      </Layer3>
      <Layer2 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>PubChem API</h4>
        <span>Live hazard and handling data retrieval queries</span>
      </Layer2>
      <Layer1 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>SDS Generator</h4>
        <span>React & Node.js safety documentation app</span>
      </Layer1>
    </>
  );
}

ChemicalSDSImages.propTypes = {
...
export default ChemicalSDSImages;
