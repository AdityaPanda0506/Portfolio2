...
const CloudGuardImages = ({ scrollPercent: initialScrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={scrollPercent}>
        ...
        <h4>Amazon SNS</h4>
        <span>Real-time slack/email notification alerts</span>
      </Layer4>
      <Layer3 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>Amazon S3</h4>
        <span>Automated dataset upload ingestion trigger</span>
      </Layer3>
      <Layer2 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>AWS Lambda</h4>
        <span>Serverless real-time data quality scoring</span>
      </Layer2>
      <Layer1 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>CloudGuard Backend</h4>
        <span>Serverless Python & Pandas quality scoring</span>
      </Layer1>
    </>
  );
}

CloudGuardImages.propTypes = {
...
export default CloudGuardImages;
