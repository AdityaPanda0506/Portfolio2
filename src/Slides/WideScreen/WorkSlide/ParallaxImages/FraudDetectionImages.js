...
const FraudDetectionImages = ({ scrollPercent: initialScrollPercent, boxHeight, index, scrollHeight, screenHeight }) => {
  ...
  return (
    <>
      <Layer4 $scroll={scrollPercent}>
        ...
        <h4>Terraform IaC</h4>
        <span>Automated Cloud Provisioning</span>
      </Layer4>
      <Layer3 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>GCP Pub/Sub</h4>
        <span>Real-time Ingestion Broker</span>
      </Layer3>
      <Layer2 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>Apache Beam / Dataflow</h4>
        <span>Sub-5-second Fraud Scoring</span>
      </Layer2>
      <Layer1 $scroll={scrollPercent}>
        <div className="star">*</div>
        <h4>GCP BigQuery</h4>
        <span>Scalable Threat Data Lake</span>
      </Layer1>
    </>
  );
}

FraudDetectionImages.propTypes = {
...
export default FraudDetectionImages;
